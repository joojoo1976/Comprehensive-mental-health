...
api_router.include_router(
    sessions.router, prefix="/sessions", tags=["الجلسات"])
api_router.include_router(content.router, prefix="/content", tags=["المحتوى"])
api_router.include_router(
    analytics.router, prefix="/analytics", tags=["التحليلات"])
api_router.include_router(language.router, prefix="/language", tags=["اللغة"])
api_router.include_router(
    translations.router, prefix="/translations", tags=["الترجمات"])
api_router.include_router(auto_translate.router,
                          prefix="/auto-translate", tags=["الترجمة التلقائية"])
api_router.include_router(websocket_translate.router,
                          prefix="/websocket", tags=["WebSocket"])
api_router.include_router(default_translations.router,
                          prefix="/default-translations", tags=["الترجمات الافتراضية"])
